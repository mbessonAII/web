...
-->
  ...
  $(document).ready(function(){
    ...
    recupPhotos();//la 1ere fois n'a pas marché parce qu'il y avait des espaces dans la div year-input
    ...
    function recupPhotos (){
      console.log($("#year-input").html());
      $.post(
          'donnemoilesphotos.php', // Un script PHP que l'on va créer juste après
          {
          ...
          function(data){
              ...
              if(data == false){
                   $("#emplacementPhotos").html("<p>Erreur lors de la connexion...</p>");
              }
              else{
                //console.log(data);
                   $("#emplacementPhotos").html("<h1>"+data+"<h1>");
              }
